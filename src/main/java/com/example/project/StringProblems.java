...
public class StringProblems{
    ...
    public String conCat(String s1, String s2){
     ...
     if (s1.substring(s1.length() - 1).equals(s2.substring(0,1)) == true) {
    ...
    public String deFront(String s1){ 
        ...
        if (s1.indexOf("a") == 0) {
            String last = s1.substring(2,s1.length());
            return "a" + last;
        }
    ...
    public String fizzString(String s1){
        ...
        if(s1.substring(0,1).equals("f") && s1.substring(length - 1).equals("b")) {
            return "FizzBuzz";
        }
        if (s1.substring(0,1).equals("f")) {
            return "Fizz";
        }
        if (s1.substring(length - 1).equals("b")) {
            return "Buzz";
        }
        return s1;
    }
